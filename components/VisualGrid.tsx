const VisualGrid = () => (
  <>
    ...
    <div className="absolute right-0 top-0 z-20 h-full w-px bg-gradient-to-t from-transparent via-stone-200 dark:bg-stone-800"></div>
    <div className="absolute bottom-0 left-0 z-20 h-px w-full  bg-gradient-to-r from-transparent via-stone-200 dark:via-via-stone-800"></div>
    <div className="absolute left-0 top-0 z-20 h-full w-px  bg-gradient-to-t from-transparent via-stone-200 dark:bg-stone-800"></div>
