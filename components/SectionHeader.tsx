...
const SectionHeader = ({
  ...
  <header className="w-full h-auto border-t-[1px] border-b-[1px] border-stone-200 dark:border-stone-600">
    <div className="wrapper-no-p text-lg text-stone-400 border-l-[1px] border-r-[1px] border-stone-200 dark:border-stone-600 py-20 md:py-24 px-6 md:px-10">
