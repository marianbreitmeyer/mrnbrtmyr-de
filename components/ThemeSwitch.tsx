  ...
  return (
    <>
      <Toggle.Root
        ...
        className="transition-all duration-150 ease-in-out p-4 hover:ring-white/100 ring-1 ring-white/40 rounded-md text-white flex items-center justify-around"
